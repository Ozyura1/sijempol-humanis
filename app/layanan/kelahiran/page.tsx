            ...
            <Card>
              <CardContent className="pt-6">
                <div className="text-center space-y-4">
                  <h3 className="text-lg font-semibold">Siap Mencatatkan Kelahiran?</h3>
                  <p className="text-muted-foreground">
                    Mulai pengajuan akta kelahiran untuk bayi Anda sekarang atau cek status pengajuan yang sudah diajukan.
                  </p>
                  <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    <Link href="/dashboard/kelahiran">
